...
// });
// link.setAttribute('download', 'MintyPaper.png');
// link.setAttribute('href', myResizedData.replace("image/png", "image/octet-stream", { multiplier: 2 }));
// link.click();
...
document.getElementById('templates').addEventListener('submit', e => {
  e.preventDefault();
